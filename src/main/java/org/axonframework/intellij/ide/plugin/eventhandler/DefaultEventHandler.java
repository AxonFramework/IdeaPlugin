...
import static org.axonframework.intellij.ide.plugin.eventhandler.InternalEventTypes.ABSTRACT_ANNOTATED_AGGREGATE_ROOT;
import static org.axonframework.intellij.ide.plugin.eventhandler.InternalEventTypes.ABSTRACT_ANNOTATED_ENTITY;
...
class DefaultEventHandler implements EventHandler {
    ...
    public boolean isSagaEvent() {
        ...
        for (PsiAnnotation annotation : annotations) {
            if (EventAnnotationTypes.SAGA_EVENT_HANDLER.getFullyQualifiedName().equals(annotation.getQualifiedName())) {
                return true;
            }
        }
        return false;
